...
const EditCategoryModal = (props) => {
  ...
  const submitForm = async () => {
    ...
    let edit = await editCategory(cId, status);
    if (edit.error) {
  ...
  return (
    <Fragment>
      ...
      >
        <div className="relative bg-white w-[80%] sm:w-[60%] shadow-lg flex flex-col items-center space-y-4  overflow-y-auto px-4 py-4 md:px-8">
