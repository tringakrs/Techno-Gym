    ...
    <Fragment>
      <tr className="border-b">
          ...
          {order.allProduct.map((product) => {
            return (
              <span className="items-center space-x-2 flex">
                <span className="max-w-[150px] break-words">{product.id.pName}</span>
                {product.quantitiy === 1 ? (
                  ""
                ) : (
                  <span className="font-semibold">{product.quantitiy}x</span>
                )}
              </span>
            );
          })}
        ...
        <td className="hover:bg-gray-200 p-2 text-center">
          ${order.amount < 0.999 ? order.amount : `${order.amount}.00`}
        </td>
        <td className="hover:bg-gray-200 p-2 text-center">
          {order.transactionId}
        </td>
