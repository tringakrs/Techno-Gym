    ...
    try {
      ...
      setTimeout(() => {
        if (responseData.Product) {
          ...
          setPimage(responseData.Product.pImage);
    ...
    <Fragment>
      ...
      <section className="m-4 md:mx-12 md:my-6">
        <div className="grid grid-cols-2 md:grid-cols-12">
          <div className="col-span-2 md:col-span-7 md:max-w-[320px] lg:max-w-[500px] xl:max-w-[625px] mw ">
          <img
              onClick={(e) =>
                slideImage("increase", 0, count, setCount, pImage)
              }
              className={`${
                count === 0 ? "" : "opacity-25"
              } cursor-pointer  object-cover object-center col-span-2 md:col-span-7 md:max-w-[320px] lg:max-w-[500px] xl:max-w-[625px] mw`}
              src={`${apiURL}/uploads/products/${sProduct.pImage}`}
              alt="pic"
            />
          </div>
          <div className="col-span-2 mt-8 md:mt-0 md:col-span-4 ">
            <div className="flex flex-col leading-8">
              <div className="text-2xl tracking-wider font-normal mb-1">
                {sProduct.pName}
              </div>
            ...
            <div className="my-4 md:my-6 text-gray-600 sm:text-lg text-base break-words">
