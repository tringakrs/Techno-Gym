    ...
    <Fragment>
      ...
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3 items-center">
          <div className="hidden lg:block col-span-1 text-gray-600 mt-1">
            <span
          ...
          <div
            ...
            className="hidden lg:block  items-left col-span-1 text-center text-gray-800 font-bold tracking-widest uppercase text-2xl cursor-pointer"
          >
            TechnoGym
          </div>
          <div className="flex items-right col-span-2 lg:col-span-1 justify-end">
            ...
            {localStorage.getItem("jwt") ? (
              <Fragment>
                <div className="userDropdownBtn hover:bg-gray-200 px-2 py-2 rounded-lg relative max-[340px]:px-[3px]">
                  <svg
              ...
              <div
                ...
                className="cursor-pointer hover:bg-gray-200 px-2 py-2 max-[340px]:px-[3px] rounded-lg"
                title="Login"
              >
                <svg
            ...
            <div
              ...
              className="hover:bg-gray-200 px-2 py-2 rounded-lg relative cursor-pointer max-[340px]:px-[3px]"
              title="Cart"
            >
              <svg
                className="w-8 h-8 text-gray-600 hover:text-gray-800"
