  ...
  return (
    ...
    <div className="flex sm:flex-row items-center sm:justify-between flex-col">
        ...
        <a href="/" className="flex items-center mb-2 sm:mb-0">
            <span className="self-center tracking-[0.7rem] ml-3 font-bold uppercase sm:text-[27px] text-2xl text-white">TechnoGym</span>
        </a>
    ...
    <div className="flex flex-col-reverse sm:flex-row items-center sm:justify-between">
        ...
        <span className="sm:text-base md:text-lg text-sm  sm:text-center text-gray-400">© {moment().format("YYYY")} <a href="/" className="hover:underline">TechnoGym</a>. All Rights Reserved.
        </span>
        <div className="flex my-2 sm:my-0 space-x-6 sm:justify-center ">
            <a href="https://facebook.com/technogym" className="text-gray-500  hover:text-white">
            ...
            <a href="https://instagram.com/technogym" className="text-gray-500  hover:text-white">
            ...
            <a href="https://twitter.com/technogym" className="text-gray-500  hover:text-white">
